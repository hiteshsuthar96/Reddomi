...
const (
	...
	PortalService_UpdateLeadInteraction_FullMethodName       = "/doota.portal.v1.PortalService/UpdateLeadInteraction"
...
type PortalServiceClient interface {
	...
	UpdateLeadInteraction(ctx context.Context, in *UpdateLeadInteractionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *portalServiceClient) UpdateLeadInteraction(ctx context.Context, in *UpdateLeadInteractionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PortalService_UpdateLeadInteraction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PortalServiceServer interface {
	...
	UpdateLeadInteraction(context.Context, *UpdateLeadInteractionRequest) (*emptypb.Empty, error)
...
func (UnimplementedPortalServiceServer) UpdateLeadInteraction(context.Context, *UpdateLeadInteractionRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateLeadInteraction not implemented")
}
...
func _PortalService_UpdateLeadInteraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateLeadInteractionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PortalServiceServer).UpdateLeadInteraction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PortalService_UpdateLeadInteraction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PortalServiceServer).UpdateLeadInteraction(ctx, req.(*UpdateLeadInteractionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PortalService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateLeadInteraction",
			Handler:    _PortalService_UpdateLeadInteraction_Handler,
		},
		{
